...
std::istream& operator>>(std::istream& in, Bitmap& b)
{
    ...
    std::cout << "Bitmap Type read [" << std::dec << position << "]:  " << b.bitmap_type[0] << b.bitmap_type[1] << std::endl;
    ...
    std::cout << "Color planes read [" << std::dec << position << "]:  " << std::dec << b.number_of_color_planes << std::endl;
    ...
    std::cout << "Color depth read [" << std::dec << position << "]:  " << std::dec << b.color_depth << std::endl;
    ...
    std::cout << "Compression Method read [" << std::dec << position << "]:  " << std::dec << b.compression_method << std::endl;
    ...
    std::cout << "Data size read [" << std::dec << position << "]:  " << std::dec << b.data_size << std::endl;
    ...
    std::cout << "Horizontal resolution read [" << std::dec << position << "]:  " << std::dec << b.horizontal_resolution << std::endl;
    ...
    std::cout << "Vertical resolution read [" << std::dec << position << "]:  " << std::dec << b.vertical_resolution << std::endl;
    ...
    std::cout << "Number of colors read [" << std::dec << position << "]:  " << std::dec << b.number_of_colors << std::endl;
    ...
    std::cout << "Number of important colors read [" << std::dec << position << "]:  " << std::dec << b.important_colors << std::endl;
    ...
    if (b.color_depth == 32) {
        ...
        std::cout << "Color space read [" << std::dec << position << "]:  " << std::dec << b.color_space << std::endl;
